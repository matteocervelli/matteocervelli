...
Industrial engineer and Scalability Manager. Based in Tuscany.

I run [Ad Limen](https://www.adlimen.com) — a software company, as a single-man company.
Ad Limen builds AI-augmented tools to make business scale and grow, to work faster and more precise.

On the other side: I am a business consultant, helping Italian SMEs cross critical growth thresholds (succession, scale-up, strategic reset)
...
**Main Stack**: Python · TypeScript · Pydantic AI · FastAPI · PostgreSQL · Redis · Docker

I "write" software with the help of agentic harnesses, like Claude or Codex.
